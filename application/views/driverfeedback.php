<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Driver Feedback Management
      </h1>
    </section>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <!--  <a class="btn btn-sm btn-primary" href="<?= base_url().'login-history/'.$record->id; ?>" title="Login history"><i class="fa fa-history"></i></a> | -->
                          <a class="btn btn-sm btn-info" href="<?php echo base_url('/driverfeedback/').'editOld/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
jQuery(document).ready(function(){
    ...
    jQuery(document).on("click", ".deleteUser", function(){
        var userId = $(this).attr("data-userid"),
            hitURL = baseURL + "driverfeedback/" + "deleteUser",
            currentRow = $(this);
