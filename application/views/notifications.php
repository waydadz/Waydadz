<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a class="btn btn-primary pull-right" href="<?php echo base_url('/notification/'); ?>addNotification"><i class="fa fa-plus"></i> Add New</a>
      </h1>
    </section>
                ...
                <div class="box-body">
                  <table id="example" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                    ...
                    <tr>
                      ...
                      <td><?php echo $record->notification ?></td>
...
jQuery(document).ready(function(){
    ...
    jQuery(document).on("click", ".deleteUser", function(){
        var userId = $(this).attr("data-userid"),
            hitURL = baseURL + "notification/" + "deleteUser",
            currentRow = $(this);
