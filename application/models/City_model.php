...
class City_model extends CI_Model
{
    ...
    function addNewCity($state, $city)
    {
        $this->db2 = $this->load->database('state', TRUE);

        $this->db2->select('city');
        $this->db2->from($state);
        $query = $this->db2->get();
        $cityName=$query->result();
        $city_ar = (array)$cityName;
        //$city_ar=array($cityName);
        print_r($city_ar);
        $flag=1;
                foreach ($city_ar as $value) {
                    foreach ($value as $value_city) {
                        # code...
                ...
                else
                {
                    ...
                    $this->db2->insert($state, $data);
                    
                    $insert_id = $this->db2->insert_id();
                    return $insert_id;
                 }

        /*$sql = "INSERT INTO ".$state." VALUES (".$city.")";
