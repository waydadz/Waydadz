    ...
    */
    ...
    function index()
    {
        ...
        {        
            ...
            $count = $this->setting_model->userListingCount($searchText);

			$returns = $this->paginationCompress ( "userListing/", $count, 10 );
            
            $data['userRecords'] = $this->setting_model->userListing($searchText, $returns["page"], $returns["segment"]);
            
            $this->global['pageTitle'] = 'Waydadz : Settings';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Waydadz : Add New Settings';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Waydadz : Edit Settings';
