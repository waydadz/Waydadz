...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Waydadz : Dashboard';
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Waydadz : User Lists';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Waydadz : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Waydadz : Edit User';
